...
namespace P4Boy
{
	...
	public:
		...
		numberType Get() const { return _value; };
	...
	public:
		...
		uint8_t Get() const { return _register.Low(); };
	private:
	...
	class SubRegister_8b_High : public RegisterOperation<SubRegister_8b_High, uint8_t>
	{
		public:
			...
			uint8_t Get() const { return _register.High(); }
		private:
			Register_16b& _register;
	};
	...
	class SubRegister_1b : public RegisterOperation<SubRegister_1b<parent_register>, bool>
	{
		...
		public:
			...
			bool Get() const { return (_register.Get() >> _bitShift) & 0x1; }
		private:
